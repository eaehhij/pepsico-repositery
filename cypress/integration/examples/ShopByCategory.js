...
it('TC007 - Select the items that you are interested in', function() {

    // shopByCategory.getSnackingImage().click({ multiple: true });
    // cy.wait(3000);

    shopByCategory.getSnackingHeading().click({ multiple: true });
    cy.wait(3000);

    shopByCategory.getSnackingNextBtn().click();    
})
